                ...
                <div class="form-wizard">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <label for="financial_institution_name" class="wizard-form-text-label">1. What is the Name
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                <label style="font-weight:bold; font-size:150%">2. Who is Primary contact?
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="primary_job_title" class="wizard-form-text-label">3. What is the primary
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="contact_info" class="wizard-form-text-label">4. Who is the your contact
                                info?</label>
                            <p class="text_danger form_error"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            <label style="font-weight:bold; font-size:150%">5. What Type of Financial Institution (FI) do
                                you represent?
                            </label>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="wizard-form-radio">
                                <input name="fi_operate_accross_state" value="1" type="radio"
                                    id="federal_operate" @if (!empty($bank) && $bank->fi_operate_accross_state == 1) checked @endif>
                                <label for="federal_operate">Yes</label>
                            </div>
                            <div class="wizard-form-radio">
                                <input name="fi_operate_accross_state" value="0" type="radio" id="state_operate"
                                    @if (empty($bank) || $bank->fi_operate_accross_state == 0) checked @endif>
                                <label for="state_operate">No</label>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            <label style="font-weight:bold; font-size:150%">10. Please Check All Deliverables That Your
                                Financial Institution Performs
                            </label>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="bank_identification_no" class="wizard-form-text-label">11. What is Your Bank
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="daily_trade_volume" class="wizard-form-text-label">12. What is your Daily Trade
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="mortage_loans" class="wizard-form-text-label">Mortgage Loans</label>
                            <p class="text_danger form_error"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="credit_card" class="wizard-form-text-label">Credit Card</label>
                            <p class="text_danger form_error"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="debit_card" class="wizard-form-text-label">Debit Card</label>
                            <p class="text_danger form_error"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="wealth_advisor" class="wizard-form-text-label">Wealth Advisor</label>
                            <p class="text_danger form_error"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            <label for="help_description" class="wizard-form-text-label">14. Describe in Detail How Ginicoe Can Help You.</label>
