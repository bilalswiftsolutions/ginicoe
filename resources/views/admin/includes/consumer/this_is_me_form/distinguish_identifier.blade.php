            ...
            <div class="form-group">
                ...
                <div class="wizard-form-radio">
                    <input onclick="facial_plastic_surgery_check()" name="facial_plastic_surgery" value="1"
                        id="radio1" type="radio" @if (!empty($distinguish_identifier_info) && $distinguish_identifier_info->facial_plastic_surgery == 1) checked @endif>
                    <label for="radio1">Yes</label>
                </div>
                <div class="wizard-form-radio">
                    <input @if (empty($distinguish_identifier_info) || $distinguish_identifier_info->facial_plastic_surgery == 0) checked @endif onclick="facial_plastic_surgery_check()"
                        name="facial_plastic_surgery" value="0" id="radio2" type="radio">
                    <label for="radio2">No</label>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->right_eye == 1 ) checked @endif class="form-check-input" name="right_eye" id="right_eye">
                            <label class="form-check-label" for="right_eye">Right Eye</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->left_eye == 1 ) checked @endif  class="form-check-input" name="left_eye" id="left_eye">
                            <label class="form-check-label" for="left_eye">Left Eye</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->nose_job == 1 ) checked @endif  class="form-check-input" name="nose_job" id="nose_job">
                            <label class="form-check-label" for="nose_job">Nose Job</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->cheeks == 1 ) checked @endif  class="form-check-input" name="cheeks" id="cheeks">
                            <label class="form-check-label" for="cheeks">Cheeks</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->mouth == 1 ) checked @endif  class="form-check-input" name="mouth" id="mouth">
                            <label class="form-check-label" for="mouth">Mouth</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->chin == 1 ) checked @endif  class="form-check-input" name="chin" id="chin">
                            <label class="form-check-label" for="chin">Chin</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->fore_head == 1 ) checked @endif  class="form-check-input" name="fore_head" id="fore_head">
                            <label class="form-check-label" for="fore_head">Fore Head</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->face_lift == 1 ) checked @endif  class="form-check-input" name="face_lift" id="face_lift">
                            <label class="form-check-label" for="face_lift">Face Lift</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" @if(!empty($distinguish_identifier_info) && $distinguish_identifier_info->lips == 1 ) checked @endif  class="form-check-input" name="lips" id="lips">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <input name="plastic_surgeon_name" type="number" class="form-control wizard-required"
                            id="plastic_surgeon_name" value="{{$distinguish_identifier_info->plastic_surgeon_name ?? '' }}">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <input name="first_name_of_surgeon" type="text" class="form-control wizard-required"
                            id="first_name_of_surgeon" value="{{$distinguish_identifier_info->first_name_of_surgeon ?? '' }}">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <input name="last_name_of_surgeon" type="text" class="form-control wizard-required"
                            id="last_name_of_surgeon" value="{{$distinguish_identifier_info->last_name_of_surgeon ?? '' }}">
