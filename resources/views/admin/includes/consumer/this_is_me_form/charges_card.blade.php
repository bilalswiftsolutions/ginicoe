<fieldset class="wizard-fieldset mt-4  @if(!empty($this_is_me_return_back_data) && $this_is_me_return_back_data->fieldset_id == 'fieldset_seven') show @endif" id="fieldset_seven">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="card_number_1" value="{{$charge_card_info->card_number_1 ?? ''}}" type="number" class="form-control wizard-required" id="card_number_1"
                    required>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input  value="{{$charge_card_info->primary_first_name_1 ?? ''}}" name="primary_first_name_1" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input  value="{{$charge_card_info->primary_last_name_1 ?? ''}}" name="primary_last_name_1" type="text" class="form-control wizard-required"
    ...
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_1()" @if(!empty($charge_card_info) && $charge_card_info->card_has_secondary_auth_user_1 == 1) checked @endif name="card_has_secondary_auth_user_1"
                    value="1" id="radio1" type="radio">
                <label for="radio1">Yes</label>
            </div>
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_1()"  @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_1 == 0) checked @endif name="card_has_secondary_auth_user_1"
    ...
    <div class="row" id="secondary_card_holder_div_1"  @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_1 == 0)  style="display: none" @endif>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input value="{{$charge_card_info->secondary_first_name_1 ?? ''}}" name="secondary_first_name_1" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input value="{{$charge_card_info->secondary_last_name_1 ?? ''}}" name="secondary_last_name_1" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input value="{{$charge_card_info->secondary_mi_1 ?? ''}}" name="secondary_mi_1" type="text" class="form-control wizard-required"
                    id="secondary_mi_1">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <select class="form-control" name="secondary_card_holder_relationship_1"
                    ...
                    <option value="granddaughter" @if(!empty($charge_card_info) && $charge_card_info->secondary_card_holder_relationship_1 === 'granddaughter') selected @endif>Granddaughter</option>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <select class="form-control" name="name_of_bank_1" id="name_of_bank_1">
                    ...
                    <option value="capital_one" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_1 == 'capital_one') selected @endif>Capital One</option>
                    ...
                    <option value="navy_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_1 == 'navy_federal_credit_union') selected @endif>Navy Federal Credit Union</option>
                    <option value="pentagon_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_1 == 'pentagon_federal_credit_union') selected @endif>Pentagon Federal Credit Union</option>
                    ...
                    <option value="wells_fargo" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_1 == 'wells_fargo') selected @endif>Wells Fargo</option>
    ...
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_2()" @if(!empty($charge_card_info) && $charge_card_info->card_has_secondary_auth_user_2 == 1) checked @endif  name="card_has_secondary_auth_user_2"
                    value="1" id="radio1" type="radio">
                <label for="radio1">Yes</label>
            </div>
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_2()" @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_2 == 0) checked @endif name="card_has_secondary_auth_user_2"
                    value="0" id="radio2" type="radio">
                <label for="radio2">No</label>
            </div>
        </div>
    </div>
    <div class="row" id="secondary_card_holder_div_2"  @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_2 == 0) style="display: none" @endif>


        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input value="{{$charge_card_info->secondary_first_name_2 ?? ''}}" name="secondary_first_name_2" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input  value="{{$charge_card_info->secondary_last_name_2 ?? ''}}" name="secondary_last_name_2" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input  value="{{$charge_card_info->secondary_mi_2 ?? ''}}" name="secondary_mi_2" type="text" class="form-control wizard-required"
                    id="secondary_mi_2">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <select class="form-control" name="secondary_card_holder_relationship_2"
                    ...
                    <option value="granddaughter" @if(!empty($charge_card_info) && $charge_card_info->secondary_card_holder_relationship_2 === 'granddaughter') selected @endif>Granddaughter</option>
    ...
    <div class="row">
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <select class="form-control" name="name_of_bank_2" id="name_of_bank_2">
                    <option></option>
                    <option value="american_express" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_2 == 'american_express') selected @endif>American Express</option>
                    <option value="bank_of_america" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_2 == 'bank_of_america') selected @endif>Bank of America</option>
                    <option value="barclays" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_2 == 'barclays') selected @endif>Barclays</option>
                    <option value="capital_one" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_2 == 'capital_one') selected @endif>Capital One</option>
                    ...
                    <option value="navy_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_2 == 'navy_federal_credit_union') selected @endif>Navy Federal Credit Union</option>
                    <option value="pentagon_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_2 == 'pentagon_federal_credit_union') selected @endif>Pentagon Federal Credit Union</option>
                    ...
                    <option value="wells_fargo" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_2 == 'wells_fargo') selected @endif>Wells Fargo</option>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input  name="expiry_date_2" type="date"  value="{{$charge_card_info->expiry_date_2 ??  date('Y-m-d') }}" 
    ...
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_3()" @if(!empty($charge_card_info) && $charge_card_info->card_has_secondary_auth_user_3 == 1) checked @endif  name="card_has_secondary_auth_user_3"
                    value="1" id="radio1" type="radio">
                <label for="radio1">Yes</label>
            </div>
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_3()" @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_3 == 0) checked @endif name="card_has_secondary_auth_user_3"
                    value="0" id="radio2" type="radio">
                <label for="radio2">No</label>
            </div>
        </div>
    </div>
    <div class="row" id="secondary_card_holder_div_3"  @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_3 == 0) style="display: none" @endif>


        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_first_name_3"  value="{{$charge_card_info->secondary_first_name_3 ?? ''}}" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_last_name_3" value="{{$charge_card_info->secondary_last_name_3 ?? ''}}" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_mi_3"  value="{{$charge_card_info->secondary_mi_3 ?? ''}}" type="text" class="form-control wizard-required"
                    id="secondary_mi_3">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <select class="form-control" name="secondary_card_holder_relationship_3"
                    ...
                    <option value="granddaughter" @if(!empty($charge_card_info) && $charge_card_info->secondary_card_holder_relationship_3 === 'granddaughter') selected @endif>Granddaughter</option>
    ...
    <div class="row">
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <select class="form-control" name="name_of_bank_3" id="name_of_bank_4">
                    <option></option>
                    <option value="american_express" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_3 == 'american_express') selected @endif>American Express</option>
                    <option value="bank_of_america" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_3 == 'bank_of_america') selected @endif>Bank of America</option>
                    <option value="barclays" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_3 == 'barclays') selected @endif>Barclays</option>
                    <option value="capital_one" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_3 == 'capital_one') selected @endif>Capital One</option>
                    ...
                    <option value="navy_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_3 == 'navy_federal_credit_union') selected @endif>Navy Federal Credit Union</option>
                    <option value="pentagon_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_3 == 'pentagon_federal_credit_union') selected @endif>Pentagon Federal Credit Union</option>
                    ...
                    <option value="wells_fargo" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_3 == 'wells_fargo') selected @endif>Wells Fargo</option>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="expiry_date_3"   value="{{$charge_card_info->expiry_date_3 ?? date('Y-m-d') }}" type="date" 
    ...
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_4()" @if(!empty($charge_card_info) && $charge_card_info->card_has_secondary_auth_user_4 == 1) checked @endif  name="card_has_secondary_auth_user_4"
                    value="1" id="radio1" type="radio">
                <label for="radio1">Yes</label>
            </div>
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_4()" @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_4 == 0) checked @endif name="card_has_secondary_auth_user_4"
                    value="0" id="radio2" type="radio">
                <label for="radio2">No</label>
            </div>
        </div>
    </div>
    <div class="row" id="secondary_card_holder_div_4" @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_4 == 0) style="display: none" @endif >


        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_first_name_4"  value="{{$charge_card_info->secondary_first_name_4 ??'' }}" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_last_name_4"  value="{{$charge_card_info->secondary_last_name_4 ??'' }}" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_mi_4"  value="{{$charge_card_info->secondary_mi_4 ??'' }}" type="text" class="form-control wizard-required"
                    id="secondary_mi_4">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <select class="form-control" name="secondary_card_holder_relationship_4"
                    ...
                    <option value="granddaughter" @if(!empty($charge_card_info) && $charge_card_info->secondary_card_holder_relationship_4 === 'granddaughter') selected @endif>Granddaughter</option>
    ...
    <div class="row">
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <select class="form-control" name="name_of_bank_4" id="name_of_bank_4">
                    <option></option>
                    <option value="american_express" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_4 == 'american_express') selected @endif>American Express</option>
                    <option value="bank_of_america" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_4 == 'bank_of_america') selected @endif>Bank of America</option>
                    <option value="barclays" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_4 == 'barclays') selected @endif>Barclays</option>
                    <option value="capital_one" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_4 == 'capital_one') selected @endif>Capital One</option>
                    ...
                    <option value="navy_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_4 == 'navy_federal_credit_union') selected @endif>Navy Federal Credit Union</option>
                    <option value="pentagon_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_4 == 'pentagon_federal_credit_union') selected @endif>Pentagon Federal Credit Union</option>
                    ...
                    <option value="wells_fargo" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_4 == 'wells_fargo') selected @endif>Wells Fargo</option>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="expiry_date_4"  value="{{$charge_card_info->expiry_date_4 ?? date('Y-m-d') }}" type="date"
    ...
    <div class="col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_5()" @if(!empty($charge_card_info) && $charge_card_info->card_has_secondary_auth_user_5 == 1) checked @endif  name="card_has_secondary_auth_user_5"
                    value="1" id="radio1" type="radio">
                <label for="radio1">Yes</label>
            </div>
            <div class="wizard-form-radio">
                <input onclick="check_card_has_secondary_auth_user_5()" @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_5 == 0) checked @endif name="card_has_secondary_auth_user_5"
                    value="0" id="radio2" type="radio">
                <label for="radio2">No</label>
            </div>
        </div>
    </div>
    <div class="row" id="secondary_card_holder_div_5" @if(empty($charge_card_info) || $charge_card_info->card_has_secondary_auth_user_5 == 0) style="display: none" @endif  >


        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_first_name_5"  value="{{$charge_card_info->secondary_first_name_5 ?? '' }}" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_last_name_5"  value="{{$charge_card_info->secondary_last_name_5 ?? '' }}" type="text" class="form-control wizard-required"
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="secondary_mi_5"  value="{{$charge_card_info->secondary_mi_5 ?? '' }}" type="text" class="form-control wizard-required"
                    id="secondary_mi_5">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <select class="form-control" name="secondary_card_holder_relationship_5"
                    ...
                    <option value="girlfriend" @if(!empty($charge_card_info) && $charge_card_info->secondary_card_holder_relationship_5 === 'girlfriend') selected @endif>Girlfriend</option>
                    <option value="granddaughter" @if(!empty($charge_card_info) && $charge_card_info->secondary_card_holder_relationship_5 === 'granddaughter') selected @endif>Granddaughter</option>
    ...
    <div class="row">
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <select class="form-control" name="name_of_bank_5" id="name_of_bank_5">
                    <option></option>
                    <option value="american_express" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_5 == 'american_express') selected @endif>American Express</option>
                    <option value="bank_of_america" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_5 == 'bank_of_america') selected @endif>Bank of America</option>
                    <option value="barclays" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_5 == 'barclays') selected @endif>Barclays</option>
                    <option value="capital_one" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_5 == 'capital_one') selected @endif>Capital One</option>
                    ...
                    <option value="navy_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_5 == 'navy_federal_credit_union') selected @endif>Navy Federal Credit Union</option>
                    <option value="pentagon_federal_credit_union" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_5 == 'pentagon_federal_credit_union') selected @endif>Pentagon Federal Credit Union</option>
                    ...
                    <option value="wells_fargo" @if(!empty($charge_card_info) && $charge_card_info->name_of_bank_5 == 'wells_fargo') selected @endif>Wells Fargo</option>
        ...
        <div class="col-md-4 col-lg-4">
            <div class="form-group">
                <input name="expiry_date_5"  value="{{$charge_card_info->expiry_date_5 ?? date('Y-m-d') }}" type="date"
