...
{{-- 
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
               16.58  Do you wish to opt-in for ‘counter-part consent’ to see your global look alike?
                <div class="wizard-form-radio">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
               16.59  Do you wish to opt-in for ‘counter-part consent’ to have your global look alike(s) see you? 
                <div class="wizard-form-radio">
