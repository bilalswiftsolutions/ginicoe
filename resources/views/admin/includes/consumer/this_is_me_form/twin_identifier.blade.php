<fieldset class="wizard-fieldset show mt-4" id="fieldset_twelve">
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                <label for="dominant_hand_writing_side" class="wizard-form-text-label">12.1 What is your dominant hand
                    writing side?</label>
                <select class="form-control" name="dominant_hand_writing_side" id="dominant_hand_writing_side" >
                    <option></option>
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                <input name="twin_first_name" type="text" class="form-control wizard-" id="twin_first_name">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                <input name="twin_mi" type="text" class="form-control wizard-" id="twin_mi">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                <input name="twin_last_name" type="text" class="form-control wizard-" id="twin_last_name">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                <textarea name="twin_difference_description" type="text" class="form-control wizard-"
                    id="twin_difference_description" ></textarea>
    ...
    <div class="form-group clearfix">
        ...
        <a onclick="checkFieldSetTwinIdentifier()" href="javascript:;" id="twin_identifier_information_button" class="form-wizard-next-btn  float-right">Next</a>
    </div>
</fieldset>
