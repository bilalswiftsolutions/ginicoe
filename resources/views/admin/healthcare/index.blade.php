...
@section('admin_content')
    <div class="card shadow mb-4">
        ...
        <div class="col-lg-12 col-md-12">
            <form id="update_my_info_form" action="{{route('admin.healthcare.update_my_info.store')}}" method="post" role="form">
               @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <input name="first_name" value="{{optional($healthcare)->first_name ?? ''}}" type="text"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <input name="last_name" value="{{optional($healthcare)->last_name ?? ''}}" type="text"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <input name="email" value="{{optional($healthcare)->email ?? ''}}" type="email"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <input name="country_code" value="{{optional($healthcare)->country_code ?? ''}}" type="text"
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <input name="telephone_no" value="{{optional($healthcare)->telephone_no ?? ''}}" type="text"
                        ...
                        <div class="col-md-8 col-lg-8">
                            <div class="form-group">
                                ...
                                <textarea name="help_description" class="form-control wizard-required" id="help_description">{{optional($healthcare)->help_description ?? ''}}</textarea>
                                <p class="text_danger form_error"></p>
                            </div>
                        </div>
    ...
    <script src="{{ asset('public/backend/js/healthcare/update_my_info.js') }}"></script>
