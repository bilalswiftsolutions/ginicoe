...
<body>
    ...
    @if ($g_setting->preloader_status == 'Show')
        <div id="preloader">
            <div id="status"
                style="background-image: url({{ asset('public/uploads/' . $g_setting->preloader_photo) }})"></div>
        </div>
    @endif
                        ...
                        <ul>
                            @foreach ($dynamic_pages as $row)
                                @if (in_array($row->dynamic_page_slug, [
                                        ...
                                        'online-tracking-and-advertisement',
                                    ]))
                                    <li>
                                        <a href="{{ url('page/' . $row->dynamic_page_slug) }}">{{ $row->dynamic_page_name }}</a>
                                    </li>
                                @endif
                            @endforeach
