function get_nearest_neghbor_address_right() {
    ...
    if ($("input[name='provide_neigborhood_address_right']:checked").val() == "1") {
...
$("#neighborhood_state_right").change(function () {
    ...
    $("#neighborhood_city_right").empty().append('<option value="">Select a city</option>');

    // Populate the city select with options based on the selected state
  
    $.each(cities, function (index, city) {
        $("#neighborhood_city_right").append(`<option value="${city}">` + city + "</option>");
    });
});
...
function get_nearest_neghbor_address_left() {
    ...
    if ($("input[name='provide_neigborhood_address_left']:checked").val() == "1") {
...
$("#neighborhood_state_left").change(function () {
    ...
    // Clear the city select and add the default option
    $("#neighborhood_city_left").empty().append('<option value="">Select a city</option>');

    // Populate the city select with options based on the selected state
  
    $.each(cities, function (index, city) {
        $("#neighborhood_city_left").append(`<option value="${city}">` + city + "</option>");
    });
});

function get_nearest_neghbor_address_back() {

    if ($("input[name='provide_neigborhood_address_back']:checked").val() == "1") {
...
$("#neighborhood_state_back").change(function () {
    ...
    // Clear the city select and add the default option
    $("#neighborhood_city_back").empty().append('<option value="">Select a city</option>');

    // Populate the city select with options based on the selected state
  
    $.each(cities, function (index, city) {
        $("#neighborhood_city_back").append(`<option value="${city}">` + city + "</option>");
    });
});
...
function get_nearest_neghbor_address_front() {
    ...
    if ($("input[name='provide_neigborhood_address_front']:checked").val() == "1") {
...
$("#neighborhood_state_front").change(function () {
    ...
    // Clear the city select and add the default option
    $("#neighborhood_city_front").empty().append('<option value="">Select a city</option>');

    // Populate the city select with options based on the selected state
  
    $.each(cities, function (index, city) {
        $("#neighborhood_city_front").append(`<option value="${city}">` + city + "</option>");
    });
});
