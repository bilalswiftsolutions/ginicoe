...
class CreateChargeCardInformationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('charge_card_information', function (Blueprint $table) {
            ...
            $table->string('nickname_1');
            $table->string('primary_first_name_1');
            $table->string('primary_mi_1');
            $table->string('primary_last_name_1');
            ...
            $table->string('name_of_bank_1');
            $table->date('expiry_date_1');

            // $table->string('charge_card_to_protect_2');
            $table->string('card_number_2');
            $table->string('nickname_2');
            $table->string('primary_first_name_2');
            $table->string('primary_mi_2');
            $table->string('primary_last_name_2');
            ...
            $table->string('name_of_bank_2');
            $table->date('expiry_date_2');


            // $table->string('charge_card_to_protect_3');
            $table->string('card_number_3');
            $table->string('nickname_3');
            $table->string('primary_first_name_3');
            $table->string('primary_mi_3');
            $table->string('primary_last_name_3');
            ...
            $table->string('name_of_bank_3');
            $table->date('expiry_date_3');


            // $table->string('charge_card_to_protect_4');
            $table->string('card_number_4');
            $table->string('nickname_4');
            $table->string('primary_first_name_4');
            $table->string('primary_mi_4');
            $table->string('primary_last_name_4');
            ...
            $table->string('name_of_bank_4');
            $table->date('expiry_date_4');



            // $table->string('charge_card_to_protect_5');
            $table->string('card_number_5');
            $table->string('nickname_5');
            $table->string('primary_first_name_5');
            $table->string('primary_mi_5');
            $table->string('primary_last_name_5');
            ...
            $table->string('name_of_bank_5');
            $table->date('expiry_date_5');
